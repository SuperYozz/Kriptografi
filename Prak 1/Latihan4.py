...
def latihan2_hitung():
    try:
        ...
        if op == "+": hasil = a + b
            ...
            return
        label_hasil3.config(text=f"Hasil: {hasil}", fg="blue")
    except ValueError:
        messagebox.showerror("Error", "Masukkan angka yang valid!")
...
entry_a3 = ttk.Entry(frm2, width=10)
entry_a3.grid(row=0, column=1, padx=10)

ttk.Label(frm2, text="Angka 2:").grid(row=1, column=0, pady=5, sticky="w")
entry_b3 = ttk.Entry(frm2, width=10)
entry_b3.grid(row=1, column=1, padx=10)
...
label_hasil3 = tk.Label(frame2, text="", font=("Arial", 10), bg="#fffaf0")
...
def latihan3_hitung():
    try:
        ...
        label_hasil2.config(text=hasil, fg=warna)
    except ValueError:
        messagebox.showerror("Error", "Masukkan angka yang valid!")

tk.Label(frame3, text="Latihan 2 - Kalkulator Nilai Akhir",
...
judul = tk.Label(menu_frame, text="Kumpulan Latihan Python",
