...
class RSAApp:
    def __init__(self, root):
        ...
        tk.Button(frm_keys, text="Generate Keys", command=self.generate_keys).pack(side="left", padx=4)
        tk.Button(frm_keys, text="Clear Debug", command=self.clear_debug).pack(side="left", padx=4)
        self.lbl_keys = tk.Label(root, text="Kunci: (belum dibuat)", anchor="w", justify="left")
        ...
        tk.Button(frm_plain, text="Encrypt →", command=self.encrypt).pack(side="left", padx=6)
        ...
        tk.Button(frm_cipher, text="← Decrypt", command=self.decrypt).pack(side="left", padx=6)
        tk.Label(root, text="DEBUG:").pack(anchor="w", padx=8)
        self.debug_area = scrolledtext.ScrolledText(root, width=110, height=20, wrap="word")
    ...
    def generate_keys(self):
        ...
        self.lbl_keys.config(text=f"Public (e={self.engine.e}, n={self.engine.n})   |   Private (d={self.engine.d}, n={self.engine.n})")
